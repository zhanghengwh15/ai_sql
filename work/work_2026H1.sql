...
WHERE
        ...
        AND task.created >= '2025-01-01 00:00:00'
        AND task.created <= '2026-05-01 00:00:00'
        and taskExtend.actual_release_date <= '2026-05-01 00:00:00'
        and taskExtend.actual_release_date >= '2025-01-01 00:00:00'
...
WHERE
        ...
        and  task.participants LIKE '%6273407e191ca5fba77a52a3%'
         AND task.created >= '2025-08-01 00:00:00'
        AND task.created <= '2026-01-01 00:00:00'
        and taskExtend.actual_release_date <= '2026-01-01 00:00:00'
        and taskExtend.actual_release_date >= '2025-08-01 00:00:00'
...
WHERE
        ...
        and  task.participants LIKE '%6273407e191ca5fba77a52a3%'
         AND task.created >= '2025-08-01 00:00:00'
        AND task.created <= '2026-01-01 00:00:00'
        and taskExtend.actual_release_date <= '2026-02-01 00:00:00'
        and taskExtend.actual_release_date >= '2025-08-01 00:00:00'
 and task.task_id not in ('662a207f1d46fe6b8d8da202','65e536d0c822936cdc27a934')
